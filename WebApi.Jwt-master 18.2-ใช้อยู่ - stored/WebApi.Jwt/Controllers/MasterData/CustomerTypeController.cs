    ...
    public class CustomerTypeController : ApiController
    {
        ...
        public HttpResponseMessage GetCustomerType()
        {
...

            {
                ...
                IList<CustomerType> collection = ObjectSpace.GetObjects<CustomerType>(CriteriaOperator.Parse(" IsActive = 1", null));
                ...
                foreach (CustomerType row in collection)
                {
                    ...
                    customerType.MasterCustomerType = row.MasterCustomerType.ToString();

                    
                    customerType.Remark = "1";
